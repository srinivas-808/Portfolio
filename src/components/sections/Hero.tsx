      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className={`text-lg md:text-xl max-w-2xl mx-auto mb-4 leading-relaxed ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            I’m a <span className="text-blue-500 font-medium" ref={textRef}></span>
          </p>
          <p className={`text-lg md:text-xl max-w-2xl mx-auto mb-8 leading-relaxed ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
